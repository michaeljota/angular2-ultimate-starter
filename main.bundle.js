...
(function (global, factory) {
     true ? factory(exports, __webpack_require__("./node_modules/@angular/core/index.js"), __webpack_require__("./node_modules/@angular/http/index.js"), __webpack_require__("./node_modules/rxjs/ReplaySubject.js"), __webpack_require__("./node_modules/rxjs/Subject.js"), __webpack_require__("./node_modules/rxjs/operator/take.js")) :
...
var fakend_1 = __webpack_require__("./src/modules/fakend/index.ts");
...
var fakend_routes_1 = __webpack_require__("./src/app/fakend.routes.ts");
/**
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            imports: [
                ...
                fakend_1.FakendModule.forRoot(fakend_routes_1.API_REST),
                forms_1.FormsModule,
                http_1.HttpModule,
...
exports.API_REST = [
    // POST: /api/authentication/ Authenticate the user.
    {
        ...
        controller: function (req) {
            ...
            var filteredUsers = database.users.filter(function (user) {
    ...
    // GET: /api/users/ Get all users
    {
        ...
        controller: function (req) {
            ...
            if (req.headers.get('Authorization') === 'Bearer fake-jwt-token') {
                return new http_1.Response(new http_1.ResponseOptions({ status: 200, body: users }));
            }
            else {
                return new http_1.Response(new http_1.ResponseOptions({ status: 401 }));
            }
        }
    },
    // GET: /api/users/:id Get a user by id
    {
        ...
        controller: function (req) {
            ...
            if (req.headers.get('Authorization') === 'Bearer fake-jwt-token') {
                ...
                return new http_1.Response(new http_1.ResponseOptions({ status: 200, body: user }));
            }
            else {
    ...
    // POST: /api/users/:id Create a user
    {
        url: /\/api\/users$/,
        method: http_1.RequestMethod.Post,
        controller: function (req) {
            // get new user object from post body
            var newUser = JSON.parse(req.getBody());
            // validation
            var duplicateUser = users.filter(function (user) { return user.username === newUser.username; }).length;
            if (duplicateUser) {
                return new Error("Username '" + newUser.username + "' is already taken");
            }
            // save new user
            ...
            // respond 200 OK
            return new http_1.Response(new http_1.ResponseOptions({ status: 200 }));
        }
    },
...
/***/ "./src/modules/fakend/fakend.module.ts":
/***/ function(module, exports, __webpack_require__) {
...
var fakend_provider_1 = __webpack_require__("./src/modules/fakend/fakend.provider.ts");
var testing_1 = __webpack_require__("./node_modules/@angular/http/bundles/http-testing.umd.js");
var http_2 = __webpack_require__("./node_modules/@angular/http/index.js");
var FakendModule = (function () {
    function FakendModule() {
    }
    FakendModule.forRoot = function (apiRoutes) {
        return {
            ngModule: FakendModule,
            providers: [
                fakend_provider_1.FakendProvider.generateWith(apiRoutes),
                testing_1.MockBackend,
                http_2.BaseRequestOptions,
            ],
        };
    };
    FakendModule = __decorate([
        core_1.NgModule({
            imports: [
                http_1.HttpModule,
            ],
...
exports.FakendModule = FakendModule;


/***/ },

/***/ "./src/modules/fakend/fakend.provider.ts":
/***/ function(module, exports, __webpack_require__) {
 ...
 *
 * @export
 * @class FakendProvider
 */
var FakendProvider = (function () {
    function FakendProvider() {
    }
    /**
     *
     *
     * @static
     * @param {FakeApi} routes
     * @param {number} [throttling=500]
     * @returns
     *
     */
    FakendProvider.generateWith = function (routes, throttling) {
        if (throttling === void 0) { throttling = 500; }
        return {
                ...
                backend
                    ...
                    setTimeout(function () {
                        routes.filter(function (route) {
                            return connection.request.url.match(route.url) &&
                                connection.request.method === route.method;
                        })
                            .map(function (route) { return route.controller(connection.request); })
                            .map(function (res) {
                            if (res instanceof Error) {
                                return connection.mockError(res);
                            }
                            return connection.mockRespond(res);
                        });
                    }, throttling);
                });
    ...
    return FakendProvider;
}());
exports.FakendProvider = FakendProvider;


/***/ },

/***/ "./src/modules/fakend/index.ts":
/***/ function(module, exports, __webpack_require__) {
...
__export(__webpack_require__("./src/modules/fakend/fakend.module.ts"));
__export(__webpack_require__("./src/modules/fakend/fakend.provider.ts"));
